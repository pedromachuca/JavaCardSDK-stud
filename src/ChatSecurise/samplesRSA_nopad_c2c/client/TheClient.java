...
public class TheClient {
	...
	public void runAppliCommands() {
		...
		cmd = new CommandAPDU(new byte[] { (byte)0x90,  (byte)0xA0, (byte)0xFF, (byte)0x00, (byte)0x00 });
		resp = sendAPDU(cmd);

		System.out.println( "\nRSA no padding Automatic Decrypt Check (private key)..." );
		cmd = new CommandAPDU(new byte[] { (byte)0x90,  (byte)0xA2, (byte)0xFF, (byte)0x00, (byte)0x00 });
		resp = sendAPDU(cmd);
